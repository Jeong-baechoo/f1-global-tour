  ...
  return (
    ...
    >
      ...
      <div className="circuit-marker__dot-container">
        ...
        {/* Connection line */}
        <div className={`circuit-marker__line ${mobile ? 'circuit-marker__line--mobile' : 'circuit-marker__line--desktop'}`} />
      </div>

      {/* Label */}
      <div 
        className={`circuit-marker__label ${mobile ? 'circuit-marker__label--mobile' : 'circuit-marker__label--desktop'}`}
        data-next-race={isNextRace}
      >
        <div className={`circuit-marker__city ${mobile ? 'circuit-marker__city--mobile' : 'circuit-marker__city--desktop'}`}>
          {getText(circuit.location.city, language)}
        </div>
        <div className={`circuit-marker__country ${mobile ? 'circuit-marker__country--mobile' : 'circuit-marker__country--desktop'}`}>
