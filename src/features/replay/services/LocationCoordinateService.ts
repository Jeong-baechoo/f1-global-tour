...
export class LocationCoordinateService {
  ...
  private static readonly QUADRATIC: Record<string, QuadraticCoefficients> = {
    ...
    // netherlands(Zandvoort): 어파인 7.6m → 2차 5.7m. 1번 코너(Tarzan 뱅킹)는 다항식 한계 잔존.
    netherlands: {
      lng: [1.4518513767e-6, 1.1105899470e-7, -2.5283607344e-12, 3.1125345916e-12, -2.1803731432e-12, 4.5403281521],
      lat: [-2.0578192370e-8, 9.2390299602e-7, -1.0152962024e-13, -4.6107689677e-12, -8.3750316297e-13, 52.385821243],
    },
  };
