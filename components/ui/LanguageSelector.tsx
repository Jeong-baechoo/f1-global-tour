...
const STYLES = {
  ...
  dropdown: {
    ...
    menu: {
      ...
      mobile: 'top-full mt-2 right-0 min-w-[100px]',
      desktop: 'sm:top-auto sm:bottom-full sm:mb-2 sm:mt-0 sm:left-0 sm:right-auto sm:min-w-[140px]',
    },
    item: {
      base: 'w-full flex items-center hover:bg-white/10 transition-colors',
      mobile: 'gap-2 pl-2 py-1 pr-1 text-xs',
      desktop: 'sm:gap-3 sm:pl-3 sm:py-2 sm:pr-1 sm:text-sm',
