      ...
      map.addLayer({
        ...
        paint: {
          'fill-extrusion-color': [
            ...
            80, '#DC2626',    // 기본 빨강 (80m) - F1 핵심색
            95, '#EF4444',    // 밝은 빨강 (95m)
            
            // --- 매우 높은 구간 (Very High) - 보라색 계열 ---
            110, '#9333EA',   // 보라색 (110m)
            125, '#C084FC',   // 연보라색 (125m)
            140, '#E9D5FF',   // 매우 연한 보라색 (140m)
            
            // --- 최고점 (Peak) ---
            160, '#FAF5FF'    // 거의 흰 보라색 (160m+)
          ],
